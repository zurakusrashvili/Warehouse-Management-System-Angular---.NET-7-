        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stands_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locations_Stands_StandId",
                        column: x => x.StandId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Unknown", "Unknown", "Unknown", "1" });

            migrationBuilder.InsertData(
                table: "Stands",
                columns: new[] { "Id", "StandName", "UserId", "WarehouseId" },
                values: new object[] { 1, "Unknown", "1", 1 });

            migrationBuilder.InsertData(
                table: "Locations",
                columns: new[] { "Id", "PlaceNumber", "ShelfNumber", "StandId", "UserId" },
                values: new object[] { 1, 0, 0, 1, "1" });
